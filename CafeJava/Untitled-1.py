...
for recipe in recipes:
    cursor.execute("""
        INSERT INTO recipes (title, cuisine, description, calories, cooking_time, ingredients, steps)
        VALUES (%s, %s, %s, %s, %s, %s, %s)
    """, (
        recipe.get("title"),
        recipe.get("cuisine"),
        recipe.get("description", "Delicious recipe"),  # default description
        recipe.get("calories", 500),  # default calories
        recipe.get("cooking_time", 30),  # default cooking time
