            ...
            <%@ page isErrorPage="true" %>
                ...
                <body class="mx-auto w-[800px] mx-auto mt-10">
                    <div class="text-4xl mb-10">
                        <h1 class="font-bold text-blue-500">Login & Registeration</h1>
                    </div>
                            ...
                            <form:form action="/register" method="post" modelAttribute="user"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <form:input path="email" id="email" type="email"
                                        class="border border-gray-300 p-2 rounded" required="required" />
                                    <form:errors path="email" class="text-red-500 text-sm" />
                                </div>
                                <div class="flex flex-col">
                                    <label for="password" class="font-semibold">Password</label>
                                    <form:input path="password" id="password" type="password"
                                        class="border border-gray-300 p-2 rounded" required="true" />
