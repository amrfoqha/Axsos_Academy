            ...
            <%@ page isErrorPage="true" %>
                ...
                <body class="mx-auto w-[800px] mx-auto mt-10">
                    ...
                    <div class="text-4xl mb-10">
                        <h1 class="font-bold text-blue-500">Update a Task</h1>
                    </div>
                    <form:form action="/editTask/${task.id}" method="post" modelAttribute="task"
                        ...
                        <div class="flex flex-row gap-5 justify-center mt-5 text-xl">
                            <button type="submit" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600 ">Update
                                Task</button>
                            <a href="/dashboard"
